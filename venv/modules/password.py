# zxcvbn estimates password strength based on real-world attack patterns
from zxcvbn import zxcvbn

# getpass hides password input in the terminal
...
def check_strength (password):
  ...
  if score ==3:
    ...
    warning = feedback.get("warning") or "No specific warning"
